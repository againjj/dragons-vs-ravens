...
import com.ayaziangames.lunarbase.cards.LunarBaseAgentCardDefinition
...
import com.ayaziangames.lunarbase.cards.LunarBaseModuleCardDefinition
...
import com.ayaziangames.lunarbase.cards.LunarBaseStationCardDefinition
...
internal class LunarBaseActionEngine(
    ...
    private fun cardEffect(card: LunarBaseCard) =
        when (val definition = catalogDefinition(card)) {
            ...
            is com.ayaziangames.lunarbase.cards.LunarBaseInfluenceCardDefinition -> definition.effect
            else -> null
        }
