...
import com.ayaziangames.lunarbase.cards.LunarBaseAchievement
import com.ayaziangames.lunarbase.cards.LunarBaseCardColor
import com.ayaziangames.lunarbase.cards.LunarBaseCardDefinition
import com.ayaziangames.lunarbase.cards.LunarBaseConnectors
import com.ayaziangames.lunarbase.cards.LunarBaseStandardDeck
...
private fun LunarBaseCard.withCatalogMetadata(): LunarBaseCard {
    ...
    return when (definition) {
        is com.ayaziangames.lunarbase.cards.LunarBaseStationCardDefinition -> {
        ...
        is com.ayaziangames.lunarbase.cards.LunarBaseModuleCardDefinition -> copy(
        ...
        is com.ayaziangames.lunarbase.cards.LunarBaseAgentCardDefinition -> copy(
            name = definition.name,
            cardCost = definition.cardCost.map { it.toCardColorName() },
            onPlayingText = definition.onPlaying.toActionText()
        )
        is com.ayaziangames.lunarbase.cards.LunarBaseInfluenceCardDefinition -> copy(
            name = definition.name,
            cardCost = emptyList(),
            effectText = definition.effect.toEffectText()
        )
