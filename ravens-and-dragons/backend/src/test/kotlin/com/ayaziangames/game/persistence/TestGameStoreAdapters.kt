...
import com.ayaziangames.platform.game.runtime.GameStore
import com.ayaziangames.platform.game.runtime.InMemoryGameStore as PlatformInMemoryGameStore
import java.time.Instant

typealias ConcurrentGameUpdateException = com.ayaziangames.platform.game.runtime.ConcurrentGameUpdateException
typealias StoredGameAccess = com.ayaziangames.platform.game.runtime.StoredGameAccess
...
class JdbcGameStore(
    private val delegate: com.ayaziangames.platform.game.runtime.JdbcGameStore,
    private val gameJsonCodec: GameJsonCodec = defaultGameJsonCodec()
) : TestGameStoreAdapter {
    override fun get(gameId: String): StoredGame? =
        delegate.get(gameId)?.toStoredGame(gameJsonCodec)
...
fun defaultGameJsonCodec(): GameJsonCodec =
    GameJsonCodec(com.ayaziangames.game.session.defaultObjectMapper())
