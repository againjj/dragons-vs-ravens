...
import com.ayaziangames.game.RavensAndDragonsGameHandler
...
import com.ayaziangames.game.model.InvalidCommandException
import com.ayaziangames.game.model.GameSession
import com.ayaziangames.game.model.VersionConflictException
import com.ayaziangames.game.model.Side
import com.ayaziangames.platform.game.runtime.PlayerGameListing
import com.ayaziangames.platform.game.runtime.PlayerAccountValidator
import com.ayaziangames.game.persistence.InMemoryGameStore
import com.ayaziangames.game.persistence.TestGameStoreAdapter
import com.ayaziangames.game.persistence.defaultGameJsonCodec
...
typealias GameIdGenerator = com.ayaziangames.platform.game.runtime.GameIdGenerator
...
class GameSessionService(
    ...
    companion object {
        val defaultStaleGameThreshold: Duration =
            com.ayaziangames.platform.game.runtime.GameSessionService.defaultStaleGameThreshold
    }

    private val gameJsonCodec = defaultGameJsonCodec()
    private val delegate = com.ayaziangames.platform.game.runtime.GameSessionService(
...
private fun <T> translatePlatformExceptions(action: () -> T): T =
    try {
        action()
    } catch (exception: com.ayaziangames.platform.game.runtime.InvalidCommandException) {
        throw InvalidCommandException(exception.message ?: "Invalid command.")
    } catch (exception: com.ayaziangames.platform.game.runtime.VersionConflictException) {
